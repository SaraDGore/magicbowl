...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipe_Ingredient.listable'
        db.add_column(u'bowls_recipe_ingredient', 'listable',
    ...
    def backwards(self, orm):
        # Deleting field 'Recipe_Ingredient.listable'
        db.delete_column(u'bowls_recipe_ingredient', 'listable')


        # Changing field 'Recipe_Ingredient.amount'
        db.alter_column(u'bowls_recipe_ingredient', 'amount', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        u'bowls.recipe_ingredient': {
            ...
            'amount': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
