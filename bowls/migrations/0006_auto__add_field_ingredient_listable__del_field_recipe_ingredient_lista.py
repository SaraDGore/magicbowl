...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ingredient.listable'
        db.add_column(u'bowls_ingredient', 'listable',
    ...
    def backwards(self, orm):
        # Deleting field 'Ingredient.listable'
        db.delete_column(u'bowls_ingredient', 'listable')
